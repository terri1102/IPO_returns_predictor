...
Revision ID: 21f1ea097175
Revises: afe54af6ecee
Create Date: 2021-03-29 19:49:25.820532
...
revision = '21f1ea097175'
down_revision = 'afe54af6ecee'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('ipotype', sa.String(length=64), nullable=True),
    sa.Column('stocktype', sa.String(length=64), nullable=True),
    ...
    sa.Column('year_later', sa.Integer(), nullable=True),
